        ...
        <div class="col-xs-12 col-sm-6 col-md-8" style="" >
            <div style=" background: black;" >
                <div class="col-xs-4 col-sm-6 col-md-3" style="background: white; margin-right:10px; border: 2px solid black;">
                    <center><image src="../../img/poblacionlogo.png" style="width:90%;height:164px;"/></center>
                ...
                <div class="col-xs-7 col-sm-5 col-md-8" style="background: white;  ">
                    <div class="pull-left" style="font-size: 16px;" ><b>
                        ...
                        <center>Municipality of Naawan</center>
                        <center>Province of Misamis Oriental</center>
                        <center>BARANGAY POBLACION</center>
                        </b>
                    </div>
                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <p style="text-indent:40px;text-align: justify;">This is to certify that the person whose photo appear herein, is a resident of Barangay Poblacion, Naaawan, Misamis Oriental and that the person had requested a clearance.</p>
                ...
                <div class="col-xs-offset-6 col-xs-5 col-md-offset-6 col-md-4" ><br><br><br>
                    ...
                    while($row=mysqli_fetch_array($qry)){
                        if($row['sPosition'] == "Captain"){
                            ...
                            <b style="font-size:15px;">'.strtoupper($row['completeName']).'
                            <span style="float: right;">Punong Barangay</span></b>
                            </p>
                            <div>
                            <img src="../../img/signature.png" style="position: absolute; top: 0; right: 0; width: 500px; height: 100px;">
                            </div>
                            </div>
                            ';
                        }
                ...
                <div class="col-xs-8 col-md-4">
                            ...
                            <p style="text-align: left;">  Not valid without barangay official seal. 
