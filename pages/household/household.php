                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"><i class="fa fa-home" aria-hidden="true"></i> Add Household</button>  
                                            ...
                                            {   
                                                ...
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>'.$row['hname'].'</td>
                                                        <td><button class="btn btn-primary btn-sm" data-target="#editModal'.$row['hid'].'" data-toggle="modal"><i class="fa fa-eye" aria-hidden="true"></i> View</button></td>
                                                    </tr>
                                                    ';
